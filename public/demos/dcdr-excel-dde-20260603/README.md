...
|---|---|
| malicious files | malicious-invoice.xlsx → cell A3 contains the DDE formula `=cmd|'/c start calc.exe'!A0` (Excel shows a DDE warning; LibreOffice displays the formula) |
